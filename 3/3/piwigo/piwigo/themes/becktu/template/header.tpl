...
<link rel="shortcut icon" type="image/x-icon" href="{$ROOT_URL}themes/becktu/images/becktu-ico-3.0.png">
...
<!--[if lt IE 7]>
<script type="text/javascript" src="{$ROOT_URL}themes/becktu/js/pngfix.js"></script>
<![endif]-->
