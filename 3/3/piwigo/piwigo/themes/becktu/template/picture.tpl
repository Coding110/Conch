...
{strip}<a id="derivativeSwitchLink" title="{'Photo sizes'|@translate}" class="pwg-state-default pwg-button" rel="nofollow">
  <span class="glyphicon glyphicon-resize-small"></span><span class="pwg-button-text">{'Photo sizes'|@translate}</span>
</a>
...
{strip}{if isset($U_SLIDESHOW_START)}
	<a href="{$U_SLIDESHOW_START}" title="{'slideshow'|@translate}" class="pwg-state-default pwg-button" rel="nofollow">
		<span class="glyphicon glyphicon-facetime-video"></span><span class="pwg-button-text">{'slideshow'|@translate}</span>
	</a>
{/if}{/strip}
{strip}{if isset($U_METADATA)}
	<a href="{$U_METADATA}" title="{'Show file metadata'|@translate}" class="pwg-state-default pwg-button" rel="nofollow">
		<span class="glyphicon glyphicon-info-sign"></span><span class="pwg-button-text">{'Show file metadata'|@translate}</span>
	</a>
{/if}{/strip}
{strip}{if isset($current.U_DOWNLOAD)}
	<a href="{$current.U_DOWNLOAD}" title="{'Download this file'|@translate}" class="pwg-state-default pwg-button" rel="nofollow">
		<span class="glyphicon glyphicon-arrow-down"></span><span class="pwg-button-text">{'Download'|@translate}</span>
	</a>
{/if}{/strip}
...
{strip}{if isset($U_SET_AS_REPRESENTATIVE)}
	<a id="cmdSetRepresentative" href="{$U_SET_AS_REPRESENTATIVE}" title="{'set as album representative'|@translate}" class="pwg-state-default pwg-button" rel="nofollow">
		<span class="glyphicon glyphicon-resize-small"></span><span class="pwg-button-text">{'representative'|@translate}</span>
	</a>
{/if}{/strip}
{strip}{if isset($U_PHOTO_ADMIN)}
	<a id="cmdEditPhoto" href="{$U_PHOTO_ADMIN}" title="{'Modify information'|@translate}" class="pwg-state-default pwg-button" rel="nofollow">
		<span class="glyphicon glyphicon-cog"></span><span class="pwg-button-text">{'Edit'|@translate}</span>
	</a>
{/if}{/strip}
...
{/footer_script}
	<a href="{$U_CADDIE}" onclick="addToCadie(this, '{$ROOT_URL}', {$current.id}); return false;" title="{'Add to caddie'|@translate}" class="pwg-state-default pwg-button" rel="nofollow">
		<span class="glyphicon glyphicon-bookmark"> </span><span class="pwg-button-text">{'Caddie'|@translate}</span>
	</a>
		...
		<div id="commentAdd">
			...
			<form method="post" action="{$comment_add.F_ACTION}" id="addComment">
				...
				<p><input type="hidden" name="key" value="{$comment_add.KEY}">
					<input type="submit" class="btn btn-default" value="{'Submit'|@translate}"></p>
			</form>
		</div>
		{/if}
		{if isset($comments)}
