 ...
 *
 */
function get_mail_info($hd, $user_id)
{
	//global $conf;
 ...
 *
 */
function update_file_info($hd, $image_id, $img_info)
{
	single_update_emfs(
		$hd,
		EMFS_FILES_TABLE,
 ...
 * @return void
 */
function single_update_emfs($hd, $tablename, $set_fields, $where_fields, $flags=0)
{
